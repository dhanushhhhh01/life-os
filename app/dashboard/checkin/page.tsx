...
var moodOptions = [
  ...
  { value: 10, label: "Amazing", color: "var(--app-primary)", bg: "rgba(129,140,248,0.12)", border: "rgba(129,140,248,0.35)", glow: "rgba(129,140,248,0.25)" },
];
...
var energyOptions = [
  ...
  { value: 10, label: "MAX!", color: "var(--app-secondary)", bg: "rgba(251,226,180,0.12)", border: "rgba(251,226,180,0.35)", glow: "rgba(251,226,180,0.35)" },
];
...
export default function CheckinPage() {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-3xl mx-auto space-y-5 stagger-children">
      {/* XP Toast */}
      {xpToast && (
        <div className="fixed top-6 right-6 z-50 px-5 py-3 rounded-xl bg-gradient-to-r from-theme-primary to-theme-secondary text-white text-sm font-bold shadow-2xl shadow-theme-primary/30 animate-fade-in flex items-center gap-2">
      ...
      <div className="flex items-center gap-2 mb-1">
        <CalendarCheck size={18} className="text-theme-secondary" />
      ...
      <div className="glass-card p-6 rounded-2xl border border-white/[0.06]">
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2">
            <Heart size={15} className="text-theme-primary" />
      ...
      <div className="glass-card p-6 rounded-2xl border border-white/[0.06]">
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2">
            <Zap size={15} className="text-theme-secondary" />
          ...
          <button
            ...
            className={"ml-auto px-6 py-3 text-white font-semibold rounded-xl transition-all text-sm flex items-center gap-2 " + (
              submitted
                ...
                : "bg-gradient-to-r from-theme-primary to-theme-secondary hover:opacity-90 shadow-lg shadow-theme-primary/20 disabled:opacity-50"
            )}
          >
            {submitted ? (
