    ...
    <div className="p-6 lg:p-8 space-y-8 min-h-full">
      ...
      <div className="animate-fade-in">
        ...
        <h1 className="text-3xl lg:text-4xl font-black text-white">
          Achievements <span className="text-gradient-cyan font-display">& XP</span>
        </h1>
        <p className="text-gray-500 mt-1.5 text-sm">Level up your life — unlock badges and earn XP</p>
      </div>

      {/* XP / Level card */}
      <div className="glass-card p-6 rounded-2xl border border-purple-500/20 bg-purple-500/[0.03] animate-fade-in">
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex-1 min-w-[200px]">
            <div className="flex justify-between text-xs text-gray-500 mb-2">
              ...
              <span className="font-display text-purple-400">{xpInLevel}/100 XP</span>
            </div>
            <div className="h-3 bg-white/[0.05] rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full transition-all duration-1000 shadow-[0_0_10px_rgba(139,92,246,0.5)]"
        ...
        <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            { action: "Focus session", xp: "+25 XP", color: "text-cyan-400" },
          ].map(function(item) {
            return (
