...
export default function AchievementsPage() {
  ...
  return (
    <div className="p-6 lg:p-8 space-y-8 min-h-full">
      ...
      {/* XP / Level card */}
      <div className="glass-card p-6 rounded-2xl border border-theme-primary/20 bg-theme-primary/[0.03] animate-fade-in">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-5">
            {/* Level badge */}
            <div className="relative">
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-theme-primary to-theme-secondary flex items-center justify-center shadow-lg shadow-theme-primary/20">
          ...
          <div className="flex-1 min-w-[200px]">
            <div className="flex justify-between text-xs text-gray-500 mb-2">
              ...
              <span className="font-display text-theme-primary">{xpInLevel}/100 XP</span>
            </div>
            <div className="h-3 bg-white/[0.05] rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-theme-primary to-theme-secondary rounded-full transition-all duration-1000 shadow-[0_0_10px_rgba(70,240,210,0.5)]"
        ...
        <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            { action: "Journal entry", xp: "+30 XP", color: "text-theme-primary" },
            { action: "Focus session", xp: "+25 XP", color: "text-theme-secondary" },
          ].map(function(item) {
            return (
